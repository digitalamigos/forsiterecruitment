...
function lazy_load_responsive_images_modify_post_thumbnail_attr( $attr, $attachment, $size ) {
     ...
     if( !is_admin() ) {
       $attr['src'] = 'data:image/gif;base64,R0lGODlhAQABAIABAEdJRgAAACwAAAAAAQABAAACAkQBAA==';
       $attr['class'] .= ' lazyload';
     }
...
add_filter( 'wp_get_attachment_image_attributes', __NAMESPACE__ . '\\lazy_load_responsive_images_modify_post_thumbnail_attr', 20, 3);
...
if( function_exists('acf_add_options_page') ) {
  ...
  acf_add_options_page(array(
    'page_title'  => 'Forsite Theme Settings',
    'menu_title'  => 'Forsite Theme Settings',
