  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-lg-4 order-lg-2 d-flex justify-content-center justify-content-lg-end mb-3">
            <a href="<?= esc_url(home_url('/')); ?>" title="Forsite Partners">
                <img class="footer-logo d-block d-lg-none img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-footer-mobile.png" alt="<?php bloginfo('name'); ?>">
    ...
    <div class="d-flex justify-content-between justify-content-lg-end align-items-center mb-2 mb-lg-3">
        <ul class="footer-social list-inline d-block d-lg-none mb-0">
            ...
            <li class="list-inline-item mr-3"><a href="tel:<?php the_field('contact_number', 'option'); ?>"><i class="fa fa-phone" aria-hidden="true"></i> <span class="sr-only"><?php the_field('contact_number', 'option'); ?></span></a></li>
            <?php endif; ?>
            <?php if(get_field('social_linkedin', 'option')): ?>
            <li class="list-inline-item"><a href="<?php the_field('linkedin_link', 'option'); ?>"><i class="fa fa-linkedin-square" aria-hidden="true"></i> <span class="sr-only">Linkedin</span></a></li>
            <?php endif; ?>
        </ul>        
    </div>
  </div>
